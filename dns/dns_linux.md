...
![image](dns/dns_quest_img/dns_linux/02_fichier_declaration_zone.png)   
---  
#### 2) Configuration du fichier de la **Zone directe** du serveur

![image](dns/dns_quest_img/dns_linux/03_fichier_zone_directe.png) 
---  
#### 3) Configuration du fichier de la **Zone indirecte** du serveur

![image](dns/dns_quest_img/dns_linux/04_fichier_zone_indirecte.png) 
---  
#### 4 et 5) Les Résultats de la commande nslookup depuis le client vers le serveur DNS

![image](dns/dns_quest_img/dns_linux/05_test_dns_and_reverse.png) 
